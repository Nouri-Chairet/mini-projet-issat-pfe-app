...
export default function EnseignantDashboard({
  ...
  const mesSujets = sujets.filter(
    (sujet) => sujet.encadreur.name === user.name,
  );
  const mesJurys = sujets.filter((sujet) =>
  ...
  return (
    <div style={{ padding: "36px 40px", maxWidth: 1100 }}>
      <div className="fu" style={{ marginBottom: 44 }}>
        ...
        >
          {mesSujets.length} sujet(s) encadré(s) · {total} participations
          totales
        </p>
      </div>
      ...
      >
        <Stat
          ...
          value={mesSujets.length}
          accent={A}
          sub={`${mesSujets.length * 3} participations requises`}
        />
        <Stat
          label="Jurys assignés"
          value={mesJurys.length}
          accent="var(--etu-accent)"
          sub="Comme président ou rapporteur"
        />
        <Stat
          label="Disponibilités"
          value={prof.disponibilites.length}
          ...
          >
            ...
            >
              <div
                style={{
                  height: "100%",
                  width: `${Math.min(100, (total / Math.max(1, mesSujets.length * 3)) * 100)}%`,
                  background: A,
                  borderRadius: 3,
            ...
            {[
              ...
              <button
                ...
                style={{
                  ...
                  textAlign: "left",
                  gridColumn: label === "Disponibilités" ? "span 2" : "auto",
                }}
                onMouseEnter={(e) => {
                  e.currentTarget.style.borderColor = `${A}40`;
              ...
              >
                <span style={{ color: A, fontSize: 16 }}>{icon}</span>
